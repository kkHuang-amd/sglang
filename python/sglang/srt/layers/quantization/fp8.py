...
class Fp8MoEMethod:
    ...
    def apply(
        ...
        w13_weight = wint4_perchannel_to_fp8_dequantize_triton(layer.w13_weight, layer.w13_weight_scale1)
        w2_weight = wint4_perchannel_to_fp8_dequantize_triton(layer.w2_weight, layer.w2_weight_scale1)
